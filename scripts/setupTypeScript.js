...
// mv src/NavBar.js to NavBar.ts - note, we need to edit rollup.config.js for this too
const beforeMainJSPath = path.join(projectRoot, "src", "NavBar.js");
const afterMainTSPath = path.join(projectRoot, "src", "NavBar.ts");
